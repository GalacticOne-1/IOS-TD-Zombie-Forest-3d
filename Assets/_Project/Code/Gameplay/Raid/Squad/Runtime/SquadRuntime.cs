...
{
    /// <summary>
    /// Runtime-состояние отряда в рейде.
    /// Отслеживает живых бойцов и потери.
    /// </summary>
    public sealed class SquadRuntime : RaidUnitRosterRuntime
    {
            ...
            SurvivorConsumptionConfig consumptionConfig)
        {
            ...
            foreach (var u in metaUnits)
            {
                ...
                result.Add(new RaidUnitRuntime(snapshot, consumptionConfig, false));
            }
