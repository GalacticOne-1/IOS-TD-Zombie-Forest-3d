...
namespace Galactic1
{
    public class DevSceneEntryPoint : MonoBehaviour
    {
        [SerializeField] private UILocationRootBinder _sceneUIRootPrefab;
        
        
        public Observable<LocationExitParams> Run(DIContainer container, DevSceneEnterParams devSceneEnterParams)
        {
            ...
            DevSceneRegistrations.Register(container, devSceneEnterParams);
