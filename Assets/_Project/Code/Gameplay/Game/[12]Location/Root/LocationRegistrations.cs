...
namespace Galactic1
{
    public static class LocationRegistrations
    {
        public static void Register(DIContainer container, LocationEnterParams locationEnterParams)
        {
             ...
             */
            var loadingWorldStateId = locationEnterParams.WorldStateId;
            ...
            GameObject.FindObjectOfType<LocationServiceLocatorAssembler>().Initialize(container);
