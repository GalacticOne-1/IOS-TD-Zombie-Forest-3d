...
namespace Galactic1.Code.Gameplay.Equipment_Preview
{
    ...
    public class EquipmentVisualHandler_Preview : IEquipmentVisualHandler
    {
        ...
        public EquipmentVisualHandler_Preview(GameObject instance)
        {
            _instance = instance;
        }
        ...
        public void BindVisual(EquipSlotType slot, ItemConfig item, int slotIndex)
        {
            ...
            if (slot == EquipSlotType.Weapon)                     
            {
                ...
                _instance.GetComponentInChildren<UnitAnimationController>().SetWeapon(item.Weapon.Info.weaponType);
                return;
            }
