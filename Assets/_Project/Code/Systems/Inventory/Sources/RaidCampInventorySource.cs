...
namespace Galactic1.Code.Inventory.Sources
{
    ...
    /// </summary>
    public sealed class RaidCampInventorySource : IInventorySource, IInventoryResourcesPort
    {
        
        public string SourceId { get; }
        public object Owner { get; }
        public InventorySourceType Type => InventorySourceType.BaseStorage;
        ...
        public RaidCampInventorySource(
            string sourceId,
            object owner,
...
#if UNITY_EDITOR
            DLog.Alert($"Set slot => RaidCampInventorySource [{slot.Item}]", 
                EDlogColor.YELLOW, 
