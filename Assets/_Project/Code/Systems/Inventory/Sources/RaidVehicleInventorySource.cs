...
namespace Galactic1.Code.Inventory.Sources
{
    ...
    /// </summary>
    public sealed class RaidVehicleInventorySource : IInventorySource, IInventoryResourcesPort
    {
        
        public string SourceId { get; }
        public object Owner { get; }
        public InventorySourceType Type => InventorySourceType.TransportCargo;
        ...
        public RaidVehicleInventorySource(
            string sourceId,
            object owner,
...
#if UNITY_EDITOR
            DLog.Alert($"Set slot => RaidVehicleInventorySource [{slot.Item}]", 
                EDlogColor.YELLOW, 
